...
?>
    ...
    <header id="headermeal">
        ...
        <a  href="new_alt.php?user_id=<?php echo $ro['user_id']; ?>" id="altbtn" onclick="altplanshow();">Alternative Plan</a>
    </header>
    <section>
...
<script>
    ...
    function altplanshow(){
        document.getElementById("altplan").style.display="block";
