        ...
        <article id="page_content">
            <div class="servicescard">
                <div class="services">
                    ...
                    <a class="arrow" href="meals.php?user_id=<?php echo $ro['user_id']; ?>"><img class="nextarrow" src="images/arrow.png" alt="arrow next" width="50px" ></a>
                </div>
                <div class="services">
            ...
            <?php
            $copon = mysqli_query($db,"select * from subcribe where s_id='2'");
